...
echo "src/gz m0eak_feeds https://github.com/m0eak/Openwrt_Packages/tree/master/AXT1800" >>/etc/opkg/customfeeds.conf
opkg update
action="$1"
case "${action}" in
ssr-plus)
...
passwall)
	...
	;;
openclash)
	wget -qO- https://github.com/gh/m0eak/Install-Openclash-for-Axt1800/install_clash.sh | sh
	;;
*)
