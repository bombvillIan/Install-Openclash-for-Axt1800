...
echo "src/gz m0eak_feeds https://raw.githubusercontent.com/bombvillIan/Openwrt_Packages/main/AXT1800/Packages.gz" >>/etc/opkg/customfeeds.conf
opkg update
action="$1"
case "${action}" in
ssr-plus)
...
passwall)
	...
	;;
openclash)
	wget -qO- https://raw.githubusercontent.com/gh/m0eak/Install-Openclash-for-Axt1800/install_clash.sh | sh
	;;
*)
